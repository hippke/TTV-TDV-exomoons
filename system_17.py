...
secondmoon.px = 0.51097431 * 10**9

thirdmoon = Body()
thirdmoon.mass = M_gan
thirdmoon.px = 0.66956576 * 10**9

fourthmoon = Body()
fourthmoon.mass = M_gan
fourthmoon.px = 1.06286939 * 10**9
...
plt.xlim(-0.11, +0.11)
plt.ylim(-0.8, +0.8)
plt.annotate(r"4:3:2:1", xy=(-0.105, +0.7), size=16)


plt.savefig("fig_system_17.eps", bbox_inches = 'tight')
